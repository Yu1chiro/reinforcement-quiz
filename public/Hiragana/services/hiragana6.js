...
const hiraganaData = {
    // Level 1 - Basic
    'ざ': { romaji: 'za', level: 1, probability: 1 },
    'じ': { romaji: 'ji', level: 1, probability: 1 },
    'ず': { romaji: 'zu', level: 1, probability: 1 },
    'ぜ': { romaji: 'ze', level: 1, probability: 1 },
    'ぞ': { romaji: 'zo', level: 1, probability: 1 },
    // Level 2 - Medium
    'だ': { romaji: 'da', level: 2, probability: 1 },
    'ぢ': { romaji: 'zi', level: 2, probability: 1 },
    'づ': { romaji: 'zu', level: 2, probability: 1 },
    // Level 3 - Hard
    'で': { romaji: 'de', level: 3, probability: 1 },
    'ど': { romaji: 'do', level: 3, probability: 1 }
};
