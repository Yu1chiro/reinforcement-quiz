...
const hiraganaData = {
    // Level 1 - Basic
    'ひゃ': { romaji: 'hya', level: 1, probability: 1 },
    'ひゅ': { romaji: 'hyu', level: 1, probability: 1 },
    'ひょ': { romaji: 'hyo', level: 1, probability: 1 },
    'りゃ': { romaji: 'rya', level: 1, probability: 1 },
    'りゅ': { romaji: 'ryu', level: 1, probability: 1 },
    // Level 2 - Medium
    'りょ': { romaji: 'ryo', level: 2, probability: 1 },
    'にゃ': { romaji: 'nya', level: 2, probability: 1 },
    'にゅ': { romaji: 'nyu', level: 2, probability: 1 },
    // Level 3 - Hard
    'にょ': { romaji: 'nyo', level: 3, probability: 1 },
};
