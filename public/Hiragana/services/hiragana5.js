...
const hiraganaData = {
    // Level 1 - Basic
    'ま': { romaji: 'ma', level: 1, probability: 1 },
    'み': { romaji: 'mi', level: 1, probability: 1 },
    'む': { romaji: 'mu', level: 1, probability: 1 },
    'め': { romaji: 'me', level: 1, probability: 1 },
    'も': { romaji: 'mo', level: 1, probability: 1 },
    // Level 2 - Medium
    'ら': { romaji: 'ra', level: 2, probability: 1 },
    'り': { romaji: 'ri', level: 2, probability: 1 },
    'る': { romaji: 'ru', level: 2, probability: 1 },
    // Level 3 - Hard
    'れ': { romaji: 're', level: 3, probability: 1 },
    'ろ': { romaji: 'ro', level: 3, probability: 1 }
};
