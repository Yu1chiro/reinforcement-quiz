...
const hiraganaData = {
    // Level 1 - Basic
    'た': { romaji: 'ta', level: 1, probability: 1 },
    'ち': { romaji: 'chi', level: 1, probability: 1 },
    'つ': { romaji: 'tsu', level: 1, probability: 1 },
    'て': { romaji: 'te', level: 1, probability: 1 },
    'と': { romaji: 'to', level: 1, probability: 1 },
    // Level 2 - Medium
    'な': { romaji: 'na', level: 2, probability: 1 },
    'に': { romaji: 'ni', level: 2, probability: 1 },
    'ぬ': { romaji: 'nu', level: 2, probability: 1 },
    // Level 3 - Hard
    'ね': { romaji: 'ne', level: 3, probability: 1 },
    'の': { romaji: 'no', level: 3, probability: 1 }
};
