...
const hiraganaData = {
    // Level 1 - Basic
    'ば': { romaji: 'ba', level: 1, probability: 1 },
    'び': { romaji: 'bi', level: 1, probability: 1 },
    'ぶ': { romaji: 'bu', level: 1, probability: 1 },
    'べ': { romaji: 'be', level: 1, probability: 1 },
    'ぼ': { romaji: 'bo', level: 1, probability: 1 },
    // Level 2 - Medium
    'ぱ': { romaji: 'pa', level: 2, probability: 1 },
    'ぴ': { romaji: 'pi', level: 2, probability: 1 },
    'ぷ': { romaji: 'pu', level: 2, probability: 1 },
    // Level 3 - Hard
    'ぺ': { romaji: 'pe', level: 3, probability: 1 },
    'ぽ': { romaji: 'po', level: 3, probability: 1 }
};
