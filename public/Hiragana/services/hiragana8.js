...
const hiraganaData = {
    // Level 1 - Basic
    'きゃ': { romaji: 'kya', level: 1, probability: 1 },
    'きゅ': { romaji: 'kyu', level: 1, probability: 1 },
    'きょ': { romaji: 'kyo', level: 1, probability: 1 },
    'しゃ': { romaji: 'sha', level: 1, probability: 1 },
    'しゅ': { romaji: 'shu', level: 1, probability: 1 },
    // Level 2 - Medium
    'しょ': { romaji: 'sho', level: 2, probability: 1 },
    'ちゃ': { romaji: 'cha', level: 2, probability: 1 },
    'ちゅ': { romaji: 'chu', level: 2, probability: 1 },
    // Level 3 - Hard
    'ちょ': { romaji: 'cho', level: 3, probability: 1 },
};
