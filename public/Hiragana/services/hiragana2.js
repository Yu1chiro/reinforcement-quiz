...
const hiraganaData = {
    // Level 1 - Basic
    'が': { romaji: 'ga', level: 1, probability: 1 },
    'ぎ': { romaji: 'gi', level: 1, probability: 1 },
    'ぐ': { romaji: 'gu', level: 1, probability: 1 },
    'げ': { romaji: 'ge', level: 1, probability: 1 },
    'ご': { romaji: 'go', level: 1, probability: 1 },
    // Level 2 - Medium
    'さ': { romaji: 'sa', level: 2, probability: 1 },
    'し': { romaji: 'shi', level: 2, probability: 1 },
    'す': { romaji: 'su', level: 2, probability: 1 },
    // Level 3 - Hard
    'せ': { romaji: 'se', level: 3, probability: 1 },
    'そ': { romaji: 'so', level: 3, probability: 1 }
};
